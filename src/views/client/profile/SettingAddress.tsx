                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="form-group focused">
                                ...
                                <input id="input-address" className="form-control form-control-alternative l" placeholder="Địa chỉ" defaultValue={addre} readOnly />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="pl-lg-4">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="form-group focused">
                                <label className="form-control-label" htmlFor="input-address">Địa chỉ</label>
                                <input id="input-address" className="form-control form-control-alternative l text-black" placeholder="Địa chỉ" defaultValue={addre} readOnly />
                            </div>
                        </div>
                    </div>
                    <MyComponent />
