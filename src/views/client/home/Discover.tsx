                        ...
                        <div className="row d-flex justify-content-center">
                            <div className="col-xxl-3 col-xl-3 col-md-3 col-sm-6 col-12 text-center">
                                <div className="feature-card">
                                    ...
                                    <h4 className="text-uppercase fw-bold text-secondary pt-4">Nhiều Ưu Đãi Hấp Dẫn
                                    </h4>
                                </div>
                            </div>
                            <div className="col-xxl-3 col-xl-3 col-md-3 col-sm-6 col-12 text-center">
                                <div className="feature-card">
                                    ...
                                    <h4 className="text-uppercase fw-bold text-secondary pt-4">Voucher lên tới<br /> 22%</h4>
                                </div>
                            </div>
                            <div className="col-xxl-3 col-xl-3 col-md-3 col-sm-6 col-12 text-center">
                                <div className="feature-card">
                                    <img src="/src/assets/images/features/freindly-support.svg" />
                                    <h4 className="text-uppercase fw-bold text-secondary pt-4">Thông Tin Được Bảo Mật</h4>
                                </div>
                            </div>
                            <div className="col-xxl-3 col-xl-3 col-md-3 col-sm-6 col-12 text-center">
                                <div className="feature-card">
                                    <img src="/src/assets/images/features/creative.svg" />
                                    <h4 className="text-uppercase fw-bold text-secondary pt-4">Nhiều Ưu Đãi Khác</h4>
                                </div>
                            </div>
                        </div>
                    </div></section>
