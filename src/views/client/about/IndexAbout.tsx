    ...
    return (
        <div>
            <div>
                ...
                <title>Cà Phê MM</title>
                <link rel="stylesheet" href="../dist/css/iconfont/tabler-icons.css" />
                <link rel="stylesheet" href="../dist/css/style.css" />
                <link rel="icon" href="../assets/images/logo_coffee.png" type="image/x-icon" />
                <link rel="shortcut icon" href="../assets/images/logo_coffee.png" type="image/x-icon" />
                {/*--------------------------*/}
                {/* Header Start */}
                {/*--------------------------*/}
                {/*--------------------------*/}
                ...
                {/* Blog Section Start */}
                {/*-----------------------------*/}
                <section className="section-bg-icons position-relative" style={{ paddingTop: 150 }}>
                    {/*--------------------------*/}
