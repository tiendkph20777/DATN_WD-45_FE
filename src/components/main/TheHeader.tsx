            ...
            <header className="main-header position-fixed w-100">
                <div className=" " style={{ paddingLeft: "5%", paddingRight: "5%" }}>
                    <nav className="navbar navbar-expand-xl py-0">
                        ...
                        <Link to={"/cart"} className="d-inline-block d-lg-block d-xl-none d-xxl-none nav-toggler text-decoration-none text-capitalize mr-5">
                        ...
                        <form onSubmit={handleSubmit(onHandleSubmit)} className="form form-search d-flex w-25">
                            ...
                            <button type="submit" className="ti ti-search border border-0" style={{ fontSize: "25px", backgroundColor: "white" }}></button>
                        </form>
                                        ...
                                        <div className="dropdown">
                                            ...
                                            <div className="dropdown-content" style={{ borderRadius: "10px" }}>
                                                ...
                                                <Link to="/purchase" className='link1'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512" style={{ margin: "5px" }}><path d="M24 0C10.7 0 0 10.7 0 24S10.7 48 24 48H69.5c3.8 0 7.1 2.7 7.9 6.5l51.6 271c6.5 34 36.2 58.5 70.7 58.5H488c13.3 0 24-10.7 24-24s-10.7-24-24-24H199.7c-11.5 0-21.4-8.2-23.6-19.5L170.7 288H459.2c32.6 0 61.1-21.8 69.5-53.3l41-152.3C576.6 57 557.4 32 531.1 32h-411C111 12.8 91.6 0 69.5 0H24zM131.1 80H520.7L482.4 222.2c-2.8 10.5-12.3 17.8-23.2 17.8H161.6L131.1 80zM176 512a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm336-48a48 48 0 1 0 -96 0 48 48 0 1 0 96 0z" /></svg>
                                                    Đơn hàng
                                                </Link>
                                                {isRoles ? (
                ...
                <div className="offcanvas-header">
                    <div className="logo">
                        <a className="navbar-brand py-0 me-0" href="#"><img width="100%" height="auto"
                            src="/src/assets/images/logo.png" alt="" /></a>
                    </div>
